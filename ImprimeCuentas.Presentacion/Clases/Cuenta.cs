...
;
        ...
        protected DataTable getCuenta(int n_cuenta, int p_cuenta, int a_cuenta, string r_cuenta)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                ...
                cmdSelect.Parameters.Add("@nro_cuenta", MySqlDbType.Int32);
                cmdSelect.Parameters.Add("@part_cuenta", MySqlDbType.Int32);
                cmdSelect.Parameters.Add("@agrup_cuenta", MySqlDbType.Int32);
                cmdSelect.Parameters.Add("@rep_cuenta", MySqlDbType.VarChar);

                cmdSelect.Parameters["@nro_cuenta"].Value = n_cuenta;
                cmdSelect.Parameters["@part_cuenta"].Value = p_cuenta;
                cmdSelect.Parameters["@agrup_cuenta"].Value = a_cuenta;
                cmdSelect.Parameters["@rep_cuenta"].Value = r_cuenta;
